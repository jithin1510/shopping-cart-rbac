...

        {
          loggedInUser?.role === 'admin' || loggedInUser?.isAdmin ? (
            ...
            <>
              ...
              <Route path='/admin/vendors' element={<Protected><AdminVendorApprovalPage/></Protected>}/>
            ...
            <>
              {loggedInUser.isApproved ? (
                <>
                  ...
                  <Route path='/vendor/products' element={<Protected><VendorProductsPage/></Protected>}/>
                  <Route path='/add-product' element={<Protected><AddProductPage/></Protected>}/>
                  <Route path='/product-update/:id' element={<Protected><ProductUpdatePage/></Protected>}/>
                  <Route path='/' element={<Navigate to={'/vendor/dashboard'}/>}/>
                  <Route path='*' element={<Navigate to={'/vendor/dashboard'}/>}/>
                </>
              ) : (
                <>
                  <Route path='/vendor/pending-approval' element={<Protected><VendorPendingApprovalPage/></Protected>}/>
                  <Route path='/' element={<Navigate to={'/vendor/pending-approval'}/>}/>
                  <Route path='*' element={<Navigate to={'/vendor/pending-approval'}/>}/>
                </>
              )}
            </>
